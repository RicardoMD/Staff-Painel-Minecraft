...
<div class="container">
    ...
    <legend>Ver os IPs vinculados a determinada conta</legend>
    ...
    if (isset($_POST['verificar'])== 'verificar') {
        ...
        if (empty($nome)) {
            ...
            $query = "SELECT last_ip,last_login FROM ast_auth_multi WHERE nick='$nome'";
            $result = mysqli_query($conecta, $query);
            $busca = mysqli_num_rows($result);
            $linha = mysqli_fetch_assoc($result);

            if ($busca > 0) {
                echo "<h4>IPs utilizados pela conta $nome</h4><br/>";
                ...
                do {
                    ...
                    echo "<tr><td style='text-align: center'>[$data]</td><td> $ip </td></tr> ";
...
// fim do if
                ...
                echo "<h4>O player $nome não tem uma conta registrada no Astatine</h4>";
            }
        }
    }
    ?>
