...
?>
    ...
    <div class="container">
        ...
        <legend>Verifique o histórico de transações financeiras de um player</legend>
        <form action="" method="post" enctype='multipart/form-data' class='form-horizontal'>
            <div class='form-group'>
                <label class='col-md-4 control-label' for='player'></label>
                <div class='col-md-4'>
                    <input type="text" name="nome" id="nome" placeholder="Nick do Player" class='form-control input-md' required=''>
                </div>
            </div>
            <div class='form-group'>
                <label class='col-md-4 control-label' for='player'></label>
        ...
        if (isset($_POST['verificar'])== 'verificar') {
            ...
            $search1 = "issued server command: /money pay";
